...
export type commentaireOptionalAttributes = "id_commentaire";
export type commentaireCreationAttributes = Optional<commentaireAttributes, commentaireOptionalAttributes>;
